...
from bootstrapforum.views.view import CreateComment, PostListView, PostView, \
    AuthenticateView, CreateUserView, CabinetView, CreatePostView, DeletePostView, UpdatePostView, EditUserView
...
urlpatterns += i18n_patterns('',
                             ...
                             url(r'^userupdate/(?P<user_id>\d+)$', login_required(EditUserView.as_view()),
                                 name='userupdate'),
